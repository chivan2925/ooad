...
public class LichSuMuaHangPanel extends JPanel {
    ...
    private JPanel createTablePanel() {
        ...
        tblLichSu.setSelectionForeground(Color.BLACK);
        tblLichSu.setShowGrid(true);
        tblLichSu.setFillsViewportHeight(true);
        // Header style
        ...
        header.setDefaultRenderer(new DefaultTableCellRenderer() {
            ...
            public Component getTableCellRendererComponent(
                ...
                lbl.setOpaque(true);
                lbl.setBackground(HEADER_BG_COLOR);
                lbl.setForeground(HEADER_FG_COLOR);
    ...
    private void showOrderDetailDialog(int orderId) {
        ...
        header.setDefaultRenderer(new TableCellRenderer() {
            ...
            public Component getTableCellRendererComponent(JTable table, Object value, boolean isSelected,
                    boolean hasFocus, int row, int column) {
                JLabel label = (JLabel) new DefaultTableCellRenderer().getTableCellRendererComponent(table, value,
    ...
    // Custom renderer for the button columnb
