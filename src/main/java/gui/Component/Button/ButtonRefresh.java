...
public class ButtonRefresh extends JButton {
    private Color normalBackground = new Color(46, 125, 50);   // Xanh lục đậm chuẩn Material Design
    private Color hoverBackground = new Color(200, 230, 200);
    private Color pressedBackground = new Color(150, 200, 150);
